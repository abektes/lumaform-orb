...
One animated WebP, a 2×2 grid, 6 s seamless loop, 640 px, ~3 MB:
...
- Scale each clip to 400×400, ffmpeg `xstack` into 800×800, then scale to 640 and encode with `img2webp`.
